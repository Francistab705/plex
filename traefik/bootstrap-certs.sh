...
DOMAINS_DEFAULT="localhost 127.0.0.1 ::1 *.127.0.0.1.nip.io traefik.127.0.0.1.nip.io archon.127.0.0.1.nip.io archon-api.127.0.0.1.nip.io supabase.127.0.0.1.nip.io studio.127.0.0.1.nip.io llm.127.0.0.1.nip.io cipher.127.0.0.1.nip.io"
